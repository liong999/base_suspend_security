...
`feedback <https://github.com/OCA/server-backend/issues/new?body=module:%20base_suspend_security%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is maintained by the OCA. And modied by Liong
...
This module is part of the `OCA/server-backend <https://github.com/OCA/server-backend/tree/12.0/base_suspend_security>`_ project on GitHub.
